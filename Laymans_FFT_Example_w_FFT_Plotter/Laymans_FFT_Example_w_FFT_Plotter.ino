...
#define FFT_SIZE 256
#define SMPL_RATE 1000000 //The desired sampling frequency. for 14 bits this caps out at 1.2 MSPS.
...
void setup() {
  ...
  fft_setup(fft_handle, FFT_SIZE, win);  //Setup the FFT for the desired sample-size and window function
